...
- **Chromebook / tablet** shots show the app's portrait content column centred on the brand background — correct, because HabitHatch is large‑screen aware (it caps and centres its content).
