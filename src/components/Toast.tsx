...
// Global toast, driven by store.toast. Shows ~2.2s then fades. Matches the proto #toast.
export function Toast() {
  ...
  return (
    <Animated.View pointerEvents="none" style={[styles.wrap, { opacity, transform: [{ translateY }] }]}>
      <View style={[styles.pill, { ...shadowCard(c) }]}>
...
const styles = StyleSheet.create({
  ...
  pill: {
    ...
    borderRadius: radius.pill, maxWidth: '86%',
  },
});
